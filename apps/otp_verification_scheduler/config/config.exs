...
config :otp_verification_scheduler, Scheduler.Worker,
...
config :otp_verification_scheduler, Scheduler.Jobs.Terminator,
  validations_expired_timeout: {:system, :integer, "VALIDATIONS_EXPIRATION_PERIOD_DAYS", 30}

config :otp_verification_scheduler, Scheduler.Jobs.SmsStatusUpdater,
